...
const commands = [
  ...
  ["Bun migration fresh/upgrade/lock/rollback/retry smoke", "bun", ["scripts/migrate-bun-smoke.mjs"]],
  ...
  ["offline encrypted backup and restore validation (Bun)", "bun", ["scripts/backup-test.mjs"]],
