...
export const REQUIRED_FOREIGN_KEYS = [
  ...
  "tracegarden_correlation_suggestions_workspace_left_entry_fk",
  "tracegarden_correlation_suggestions_workspace_right_entry_fk",
  "tracegarden_correlation_suggestions_workspace_decided_by_member_fk",
  "tracegarden_confirmed_links_workspace_id_fkey",
  "tracegarden_confirmed_links_workspace_suggestion_fk",
  "tracegarden_confirmed_links_workspace_left_entry_fk",
  "tracegarden_confirmed_links_workspace_right_entry_fk",
  "tracegarden_confirmed_links_workspace_member_fk",
