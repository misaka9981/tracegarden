...
The first post-run evidence-only commit is `263bd538f8a2335827d0c51110070f36cc8b7c30` (tree `b05fccd78a769d568545297b6e90dca5898185ca`), whose parent is the VM-tested runtime source `e78d7365346315accccce4bc240ca3e2c7241b3d`. The deterministic bridge command `git diff-tree --no-commit-id --name-status -r e78d7365346315accccce4bc240ca3e2c7241b3d 263bd538f8a2335827d0c51110070f36cc8b7c30` reports exactly these metadata paths: `M .scratch/tracegarden-mvp/issues/21-prove-arm64-vm-runtime.md`, `M evidence/21-vm-runtime/report.md`, `A evidence/21-vm-runtime/vm-transcript.txt`, and `M evidence/live-acceptance-matrix.md`. The post-run evidence commits collectively alter only this allow-listed set; no runtime-bearing path changed, so no VM rerun is required. A reviewer can verify the final checkout with the same command ending at `HEAD`.
