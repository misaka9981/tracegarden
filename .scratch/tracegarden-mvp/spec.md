...
- Production web, collector, migration, and backup processes use the exact Bun 1.4.0 runtime with ESM. TypeScript 7's native `tsc` remains the authoritative compiler; Node.js 26.8.x remains the development/validation toolchain and independently recoverable rollback baseline.
